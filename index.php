                        ...
                        <div class="items width2 brand">
                            <div class="item-img">
                                ...
                                <div class="item-img-overlay valign">
                                    ...
                                    <a href="assets/img/portfolio/4.jpg" class="popimg">
                                        <i class="icofont icofont-image"></i>
                                    </a>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <input id="form_name" type="text" name="entry.1278549473" placeholder="Name">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <input id="form_mobile" type="number" name="entry.146594383" placeholder="Mobile">
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <input id="form_email" type="email" name="entry.1505590015" placeholder="Email">
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <input id="form_subject" type="text" name="entry.2136291015" placeholder="Subject">
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <textarea id="form_message" name="entry.1382707863" placeholder="Message" rows="4"></textarea>
                                        </div>
                                    </div>

                                    <div class="col-md-12 text-center">
                                        <button onclick="contactUsBtn('Hello Word!');SubmitInDatabase();" class="butn butn-bg"><span>Send Message</span></button>
                                    </div>
